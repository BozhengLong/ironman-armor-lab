...
**R16 已于 2026-09-08 发布。** 发布代码 `8e376ae`；
[GitHub Pages 发布记录（第 2 次运行）](https://github.com/BozhengLong/ironman-armor-lab/actions/runs/34180400570/attempts/2)。
完整 CI 通过，线上 HTML、CSS、两个展示模块及 RoomEnvironment 与本地构建哈希一致。
...
- 真实 iPhone 16 Pro Max / iOS 26.6.1：三套模型的阶段拆解、定位、原位对照、导览控制及
  ...
  后导览暂停、渲染计数不变，返回后可继续。控件由 DOM 事件驱动，真实手指手感待用户反馈。
...
- 实机单次武士资源请求耗时 96.8 秒，暴露弱网首开问题。已补 512px 手机贴图资源，
  ...
  本地新增载荷预算、真实资源请求与节点恢复检查已通过，补充发布与实机复查进行中。
